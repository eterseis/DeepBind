...
class App:
    ...
    def valid(self, box):
        ...
        if len(box.get().strip()) == 0:
            ...
            match box:
                case self.caixa_1:
                    keyboard.remap_key(box.get(), '1')
                case self.caixa_2:
                    keyboard.remap_key(box.get(), '2')
                case self.caixa_3:
                    keyboard.remap_key(box.get(), '3')
                case self.caixa_4:
                    keyboard.remap_key(box.get(), '4')
                case self.caixa_5:
                    keyboard.remap_key(box.get(), '5')
                case self.caixa_6:
                    keyboard.remap_key(box.get(), '6')
                case self.caixa_7:
                    keyboard.remap_key(box.get(), '7')
                case self.caixa_8:
                    keyboard.remap_key(box.get(), '8')
                case self.caixa_9:
                    keyboard.remap_key(box.get(), '9')
                case self.caixa_10:
                    keyboard.remap_key(box.get(), '0')
